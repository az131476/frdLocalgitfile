    ...
    class SocketServer
    {
        ...
        public void watchconnecting()
        {
            ...
            while (true)
            {
                ...
                //显示与客户端连接情况
                Log.Write("成功与" + remoteEndPoint + "客户端建立连接！\t\n");
                //添加客户端信息  
        ...
        static void recv(object socketclientpara)
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    Log.Write("客户端:" + socketServer.RemoteEndPoint + ",time:" + GetCurrentTime() + "\r\n" + strSRecMsg + "\r\n\n");
                ...
                catch (Exception ex)
                {
                    ...
                    Log.Write("Client Count:" + clientConnectionItems.Count);

                    //提示套接字监听异常  
                    Log.Write("客户端" + socketServer.RemoteEndPoint + "已经中断连接" + "\r\n" + ex.Message + "\r\n" + ex.StackTrace + "\r\n");
